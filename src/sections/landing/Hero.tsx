...
const Hero = () => {
  ...
  return (
    <section className="bg-primary-light hero_bg relative overflow-hidden">
      <div className="container flex md-xl:flex-row flex-col-reverse items-center gap-6 md-xl:h-[80vh]">
        <div className="md-xl:w-[45%] w-full relative pb-24 md-xl:pb-0 flex md-xl:block justify-center items-center text-center flex-col md-xl:text-left mt-24 md-xl:mt-0">
          <h1 className="text-[1.5em] md:text-[2em] text-white mb-4 md:leading-10 font-[600]">
            Innovating Architecture <br /> for a Sustainable <br /> future
          </h1>
          <p className="text-white md:text-[1em] text-[0.9em] text-opacity-70 max-w-[26em] mb-6">
          ...
          <button onClick={() => navigation.push("/about-us")} className="app_button flex items-center gap-[0.6em] z-[99] relative !py-3">
            Try a Demo
            <FaArrowRightLong />
          </button>
          <Image
            className="hidden md:block absolute top-[-30%] left-2 h-[15em] object-contain"
        ...
        <div className="relative md-xl:w-[45%] w-full mt-8 md-xl:mt-0">
          <Image
          ...
          />
          <Image
            className=" absolute z-[100] bottom-[-3em] left-[-1em] sm:left-[2%] md-xl:left-[-2em] w-[10em] md:w-[11.75em] rounded-md"
            src={HeroImage2.src}
            width={260}
            height={150}
            alt="sustAIn"
          />
          <Image
            className=" absolute z-[100] bottom-[-3em] right-[-1em] sm:right-[2%] md-xl:right-[-2em] w-[10em] md:w-[12.75em] rounded-md"
            src={HeroImage1.src}
            width={296}
            height={171}
            alt="sustAIn"
          />
          <Image
            className=" hidden md:block absolute bottom-[-30%] right-2 h-[15em] object-contain"
