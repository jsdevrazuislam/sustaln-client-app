  ...
  return (
    <section className="sec_padding">
      <div className="container">
        ...
        />
        <div className="flex items-center flex-wrap justify-center md-xl:justify-start gap-4 md:gap-8 mt-8">
          ...
          <Image src={Logo3.src} alt="sustAIn" width={205} height={150} className="w-[7em] md:w-[13em]" />
